...
__NO_RETURN void Reset_Handler(void)
{
    ...
    if (SCU_IS_CPU_NS(SCU_NS) == 0)
    {
        ...
        PMC_SetSRAMPowerMode(PMC_SYSRB0PC_SRAM0PMS_Msk |
                             ...
                             PMC_SYSRB0PC_SRAM2PMS_Msk |
                             PMC_SYSRB0PC_SRAM3PMS_Msk |
                             PMC_SYSRB0PC_SRAM4PMS_Msk |
                             PMC_SYSRB0PC_SRAM5PMS_Msk |
                             PMC_SYSRB0PC_SRAM6PMS_Msk |
                             PMC_SYSRB0PC_SRAM7PMS_Msk
                             , PMC_SYSRB0PC_SRAM_NORMAL);
        PMC_SetSRAMPowerMode(PMC_SYSRB1PC_SRAM0PMS_Msk |
                             PMC_SYSRB1PC_SRAM1PMS_Msk |
                             PMC_SYSRB1PC_SRAM2PMS_Msk |
                             PMC_SYSRB1PC_SRAM3PMS_Msk |
                             PMC_SYSRB1PC_SRAM4PMS_Msk |
                             PMC_SYSRB1PC_SRAM5PMS_Msk |
                             PMC_SYSRB1PC_SRAM6PMS_Msk |
                             PMC_SYSRB1PC_SRAM7PMS_Msk
                             , PMC_SYSRB1PC_SRAM_NORMAL);
        PMC_SetSRAMPowerMode(PMC_SYSRB2PC_SRAM0PMS_Msk |
                             PMC_SYSRB2PC_SRAM1PMS_Msk |
                             PMC_SYSRB2PC_SRAM2PMS_Msk |
                             PMC_SYSRB2PC_SRAM3PMS_Msk |
                             PMC_SYSRB2PC_SRAM4PMS_Msk
                             , PMC_SYSRB2PC_SRAM_NORMAL);
        PMC_SetSRAMPowerMode(PMC_SYSRB3PC_SRAM0PMS_Msk
                             , PMC_SYSRB3PC_SRAM_NORMAL);
        PMC_SetSRAMPowerMode(PMC_LPSYSRPC_SRAM0PMS_Msk
                             , PMC_LPSYSRPC_SRAM_NORMAL);

        // Enable SRAM0/1/2/3 clock
        CLK->SRAMCTL |= (CLK_SRAMCTL_SRAM0CKEN_Msk | CLK_SRAMCTL_SRAM1CKEN_Msk | CLK_SRAMCTL_SRAM2CKEN_Msk | CLK_SRAMCTL_SRAM3CKEN_Msk);

        // Enable LPSRAM0 clock
