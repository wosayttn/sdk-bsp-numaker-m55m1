/**************************************************************************//**
 * @file     nu_mpu_config_M55_template.h
 * @version  V1.00
 * @brief    Initial Setup for MPU region for M55
 *
 * SPDX-License-Identifier: Apache-2.0
 * @copyright (C) 2023 Nuvoton Technology Corp. All rights reserved.
 ******************************************************************************/

#ifndef __MPU_CONFIG_M55_H__
#define __MPU_CONFIG_M55_H__

/*
 * Copy from Library\StdDriver\inc\nu_mpu_config_M55_template.h
 * Rename to mpu_config_M55.h
 * Add mpu_config_M55.h folder to include path
 */
...
//   <n> MPU Region 7 is reserved for Non-cacheable region in M55 BSP
/*
// </h>
*/
