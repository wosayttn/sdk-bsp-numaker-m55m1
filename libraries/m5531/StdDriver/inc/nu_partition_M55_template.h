/**************************************************************************//**
 * @file     nu_partition_M55_template.h
 * @version  V1.00
 * @brief    Default Initial Setup for Secure / Non-secure Attribution Zones for M55
 *
 * SPDX-License-Identifier: Apache-2.0
 * @copyright (C) 2023 Nuvoton Technology Corp. All rights reserved.
 ******************************************************************************/

#ifndef PARTITION_M55_TEMPLATE_H
#define PARTITION_M55_TEMPLATE_H
...
#endif  /* PARTITION_M55_TEMPLATE_H */
