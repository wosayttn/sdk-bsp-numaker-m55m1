...
#ifndef __NU_LPPDMA_H__
#define __NU_LPPDMA_H__
...
/*---------------------------------------------------------------------------------------------------------*/
#define LPPDMA_INT_TRANS_DONE (1<<0)          /*!<Transfer Done Interrupt  \hideinitializer */
#define LPPDMA_INT_TEMPTY     (1<<1)          /*!<Table Empty Interrupt  \hideinitializer */
