...
/**
  ...
  * \hideinitializer
  */
#define EQEI_DISABLE_CNT_CMP(eeqei)    ((eeqei)->CTL &= (~EQEI_CTL_CMPEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define EQEI_ENABLE_CNT_CMP(eeqei)     ((eeqei)->CTL |= EQEI_CTL_CMPEN_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define EQEI_DISABLE_INDEX_LATCH(eeqei)     ((eeqei)->CTL &= (~EQEI_CTL_IDXLATEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define EQEI_ENABLE_INDEX_LATCH(eeqei)     ((eeqei)->CTL |= EQEI_CTL_IDXLATEN_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define EQEI_DISABLE_INDEX_RELOAD(eeqei)    ((eeqei)->CTL &= (~EQEI_CTL_IDXRLDEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define EQEI_ENABLE_INDEX_RELOAD(eeqei)    ((eeqei)->CTL |= EQEI_CTL_IDXRLDEN_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define EQEI_DISABLE_INPUT(eeqei, u32InputType)     ((eeqei)->CTL &= ~(u32InputType))
...
/**
  ...
  * \hideinitializer
  */
#define EQEI_ENABLE_INPUT(eeqei, u32InputType)     ((eeqei)->CTL |= (u32InputType))
...
/**
  ...
  * \hideinitializer
  */
#define EQEI_DISABLE_INPUT_INV(eeqei, u32InputType)    ((eeqei)->CTL &= ~(u32InputType))
...
/**
  ...
  * \hideinitializer
  */
#define EQEI_ENABLE_INPUT_INV(eeqei, u32InputType)     ((eeqei)->CTL |= (u32InputType))
