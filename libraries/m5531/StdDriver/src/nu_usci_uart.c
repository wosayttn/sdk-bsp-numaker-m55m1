 ...
 * @file     usci_uart.c
 * @version  V1.00
 * @brief    M5531 series USCI_UART driver source file
 *
...
/** @addtogroup UUART_EXPORTED_FUNCTIONS USCI_UART Exported Functions
  @{
*/
...
uint32_t UUART_Open(UUART_T *uuart, uint32_t u32baudrate)
{
    ...
    uuart->CTL = (uuart->CTL & (~UUART_CTL_FUNMODE_Msk))
                 | (2ul << UUART_CTL_FUNMODE_Pos);
