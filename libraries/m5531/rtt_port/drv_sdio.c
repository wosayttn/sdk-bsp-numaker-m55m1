...
/* Private variables ------------------------------------------------------------*/
#if defined(BSP_USING_SDH0)
    static NVT_NONCACHEABLE uint32_t g_au32CacheBuf_SDH0[SDH_BUFF_SIZE/4];
#endif

#if defined(BSP_USING_SDH1)
    static NVT_NONCACHEABLE uint32_t g_au32CacheBuf_SDH1[SDH_BUFF_SIZE/4];
#endif
...
static struct nu_sdh nu_sdh_arr [] =
{
#if defined(BSP_USING_SDH0)
    {
        ...
        .rstidx = SYS_SDH0RST,
        .modid = SDH0_MODULE,
        .cachebuf = (uint8_t *)g_au32CacheBuf_SDH0,
    },
#endif
#if defined(BSP_USING_SDH1)
    {
        ...
        .rstidx = SYS_SDH1RST,
        .modid = SDH1_MODULE,
        .cachebuf = (uint8_t *)g_au32CacheBuf_SDH1,
    },
#endif
