...
{
#if defined(BSP_USING_EPWM0_CAPTURE)
    {  .base = EPWM0, .name = "epwm0i0", .irqn = EPWM0P0_IRQn, .rstidx = SYS_EPWM0RST, .modid = EPWM0_MODULE },
    {  .base = EPWM0, .name = "epwm0i1", .irqn = EPWM0P0_IRQn, .rstidx = SYS_EPWM0RST, .modid = EPWM0_MODULE },
    {  .base = EPWM0, .name = "epwm0i2", .irqn = EPWM0P1_IRQn, .rstidx = SYS_EPWM0RST, .modid = EPWM0_MODULE },
    {  .base = EPWM0, .name = "epwm0i3", .irqn = EPWM0P1_IRQn, .rstidx = SYS_EPWM0RST, .modid = EPWM0_MODULE },
    {  .base = EPWM0, .name = "epwm0i4", .irqn = EPWM0P2_IRQn, .rstidx = SYS_EPWM0RST, .modid = EPWM0_MODULE },
    {  .base = EPWM0, .name = "epwm0i5", .irqn = EPWM0P2_IRQn, .rstidx = SYS_EPWM0RST, .modid = EPWM0_MODULE },
#endif
#if defined(BSP_USING_EPWM1_CAPTURE)
    {  .base = EPWM1, .name = "epwm1i0", .irqn = EPWM1P0_IRQn, .rstidx = SYS_EPWM1RST, .modid = EPWM1_MODULE },
    {  .base = EPWM1, .name = "epwm1i1", .irqn = EPWM1P0_IRQn, .rstidx = SYS_EPWM1RST, .modid = EPWM1_MODULE },
    {  .base = EPWM1, .name = "epwm1i2", .irqn = EPWM1P1_IRQn, .rstidx = SYS_EPWM1RST, .modid = EPWM1_MODULE },
    {  .base = EPWM1, .name = "epwm1i3", .irqn = EPWM1P1_IRQn, .rstidx = SYS_EPWM1RST, .modid = EPWM1_MODULE },
    {  .base = EPWM1, .name = "epwm1i4", .irqn = EPWM1P2_IRQn, .rstidx = SYS_EPWM1RST, .modid = EPWM1_MODULE },
    {  .base = EPWM1, .name = "epwm1i5", .irqn = EPWM1P2_IRQn, .rstidx = SYS_EPWM1RST, .modid = EPWM1_MODULE },
#endif
};
