...
static const sensor_reg_val s_sRegValue_QVGA_YUV[] =
{
    {0x0022, 0x00}, {0x0023, 0xCF}, {0x0020, 0x08}, {0x0027, 0x30},
...
{
    /* First setting table, 320x240xYUV */
    {
        .sViewInfo.u32Width = 320,
        .sViewInfo.u32Height = 240,
        .sViewInfo.pu8FarmAddr = RT_NULL, /*Unused*/
        .psRegArr = &s_sRegValue_QVGA_YUV[0],
        .u32RegArrSize = sizeof(s_sRegValue_QVGA_YUV) / sizeof(sensor_reg_val),
        .u32SenClk = 60000000,
#if defined(CONFIG_CCIR656)
    ...
    /* Second setting table, 640x480xYUV */
    {
    ...
    /* Third setting table, 1280x720xYUV */
    {
