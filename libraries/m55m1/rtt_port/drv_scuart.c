...
#if defined(BSP_USING_SCUART0)
    {
        .name = "scuart0", .base = SC0, .irqn = SC0_IRQn, .rstidx = SYS_SC0RST, .modid = SC0_MODULE,
    },
#endif
#if defined(BSP_USING_SCUART1)
    {
        .name = "scuart1", .base = SC1, .irqn = SC1_IRQn, .rstidx = SYS_SC1RST, .modid = SC1_MODULE,
    },
#endif
#if defined(BSP_USING_SCUART2)
    {
        .name = "scuart2", .base = SC2, .irqn = SC2_IRQn, .rstidx = SYS_SC2RST, .modid = SC2_MODULE,
    },
#endif
}; /* scuart nu_scuart */
