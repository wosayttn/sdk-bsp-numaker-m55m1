...
{
#if defined(BSP_USING_TIMER0)
    { .name = "timer0", .base  = TIMER0, .irqn = TIMER0_IRQn, .rstidx = SYS_TMR0RST, .modid = TMR0_MODULE  },
#endif
#if defined(BSP_USING_TIMER1)
    { .name = "timer1", .base  = TIMER1, .irqn = TIMER1_IRQn, .rstidx = SYS_TMR1RST, .modid = TMR1_MODULE  },
#endif
#if defined(BSP_USING_TIMER2)
    { .name = "timer2", .base  = TIMER2, .irqn = TIMER2_IRQn, .rstidx = SYS_TMR2RST, .modid = TMR2_MODULE  },
#endif
#if defined(BSP_USING_TIMER3)
    { .name = "timer3", .base  = TIMER3, .irqn = TIMER3_IRQn, .rstidx = SYS_TMR3RST, .modid = TMR3_MODULE  },
#endif
};
