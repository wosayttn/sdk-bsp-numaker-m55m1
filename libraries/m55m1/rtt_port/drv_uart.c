...
#if defined(BSP_USING_UART5)
    MAKE_UART_INSTANCE(5,
#if defined(RT_SERIAL_USING_DMA) && defined(BSP_USING_UART5_TX_DMA)
                       MAKE_PDMA_UART_TX(5),
#else
                       NU_PDMA_UNUSED,
#endif
#if defined(RT_SERIAL_USING_DMA) && defined(BSP_USING_UART5_RX_DMA)
                       MAKE_PDMA_UART_RX(5)
#else
                       NU_PDMA_UNUSED
#endif
...
#if defined(BSP_USING_UART6)
    MAKE_UART_INSTANCE(6,
#if defined(RT_SERIAL_USING_DMA) && defined(BSP_USING_UART6_TX_DMA)
                       MAKE_PDMA_UART_TX(6),
#else
                       NU_PDMA_UNUSED,
#endif
#if defined(RT_SERIAL_USING_DMA) && defined(BSP_USING_UART6_RX_DMA)
                       MAKE_PDMA_UART_RX(6)
#else
                       NU_PDMA_UNUSED
#endif
...
#if defined(BSP_USING_UART7)
    MAKE_UART_INSTANCE(7,
#if defined(RT_SERIAL_USING_DMA) && defined(BSP_USING_UART7_TX_DMA)
                       MAKE_PDMA_UART_TX(7),
#else
                       NU_PDMA_UNUSED,
#endif
#if defined(RT_SERIAL_USING_DMA) && defined(BSP_USING_UART7_RX_DMA)
                       MAKE_PDMA_UART_RX(7)
#else
                       NU_PDMA_UNUSED
#endif
...
#if defined(BSP_USING_UART8)
    MAKE_UART_INSTANCE(8,
#if defined(RT_SERIAL_USING_DMA) && defined(BSP_USING_UART8_TX_DMA)
                       MAKE_PDMA_UART_TX(8),
#else
                       NU_PDMA_UNUSED,
#endif
#if defined(RT_SERIAL_USING_DMA) && defined(BSP_USING_UART8_RX_DMA)
                       MAKE_PDMA_UART_RX(8)
#else
                       NU_PDMA_UNUSED
#endif
...
#if defined(BSP_USING_UART9)
    MAKE_UART_INSTANCE(9,
#if defined(RT_SERIAL_USING_DMA) && defined(BSP_USING_UART9_TX_DMA)
                       MAKE_PDMA_UART_TX(9),
#else
                       NU_PDMA_UNUSED,
#endif
#if defined(RT_SERIAL_USING_DMA) && defined(BSP_USING_UART9_RX_DMA)
                       MAKE_PDMA_UART_RX(9)
#else
                       NU_PDMA_UNUSED
#endif
