...
{
#if defined(BSP_USING_ECAP0)
    {  .base = ECAP0, .name = "ecap0i0", .irqn = ECAP0_IRQn, .rstidx = SYS_ECAP0RST, .modid = ECAP0_MODULE },
    {  .base = ECAP0, .name = "ecap0i1", .irqn = ECAP0_IRQn, .rstidx = SYS_ECAP0RST, .modid = ECAP0_MODULE },
    {  .base = ECAP0, .name = "ecap0i2", .irqn = ECAP0_IRQn, .rstidx = SYS_ECAP0RST, .modid = ECAP0_MODULE },
#endif
#if defined(BSP_USING_ECAP1)
    {  .base = ECAP1, .name = "ecap1i0", .irqn = ECAP1_IRQn, .rstidx = SYS_ECAP1RST, .modid = ECAP1_MODULE },
    {  .base = ECAP1, .name = "ecap1i1", .irqn = ECAP1_IRQn, .rstidx = SYS_ECAP1RST, .modid = ECAP1_MODULE },
    {  .base = ECAP1, .name = "ecap1i2", .irqn = ECAP1_IRQn, .rstidx = SYS_ECAP1RST, .modid = ECAP1_MODULE },
#endif
#if defined(BSP_USING_ECAP2)
    {  .base = ECAP2, .name = "ecap2i0", .irqn = ECAP2_IRQn, .rstidx = SYS_ECAP2RST, .modid = ECAP2_MODULE },
    {  .base = ECAP2, .name = "ecap2i1", .irqn = ECAP2_IRQn, .rstidx = SYS_ECAP2RST, .modid = ECAP2_MODULE },
    {  .base = ECAP2, .name = "ecap2i2", .irqn = ECAP2_IRQn, .rstidx = SYS_ECAP2RST, .modid = ECAP2_MODULE },
#endif
#if defined(BSP_USING_ECAP3)
    {  .base = ECAP3, .name = "ecap3i0", .irqn = ECAP3_IRQn, .rstidx = SYS_ECAP3RST, .modid = ECAP3_MODULE },
    {  .base = ECAP3, .name = "ecap3i1", .irqn = ECAP3_IRQn, .rstidx = SYS_ECAP3RST, .modid = ECAP3_MODULE },
    {  .base = ECAP3, .name = "ecap3i2", .irqn = ECAP3_IRQn, .rstidx = SYS_ECAP3RST, .modid = ECAP3_MODULE },
#endif
};
