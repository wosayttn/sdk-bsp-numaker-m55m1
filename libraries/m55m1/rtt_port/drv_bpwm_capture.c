...
{
#if defined(BSP_USING_BPWM0_CAPTURE)
    {  .base = BPWM0, .name = "bpwm0i0", .irqn = BPWM0_IRQn, .rstidx = SYS_BPWM0RST, .modid = BPWM0_MODULE },
    {  .base = BPWM0, .name = "bpwm0i1", .irqn = BPWM0_IRQn, .rstidx = SYS_BPWM0RST, .modid = BPWM0_MODULE },
    {  .base = BPWM0, .name = "bpwm0i2", .irqn = BPWM0_IRQn, .rstidx = SYS_BPWM0RST, .modid = BPWM0_MODULE },
    {  .base = BPWM0, .name = "bpwm0i3", .irqn = BPWM0_IRQn, .rstidx = SYS_BPWM0RST, .modid = BPWM0_MODULE },
    {  .base = BPWM0, .name = "bpwm0i4", .irqn = BPWM0_IRQn, .rstidx = SYS_BPWM0RST, .modid = BPWM0_MODULE },
    {  .base = BPWM0, .name = "bpwm0i5", .irqn = BPWM0_IRQn, .rstidx = SYS_BPWM0RST, .modid = BPWM0_MODULE },
#endif
#if defined(BSP_USING_BPWM1_CAPTURE)
    {  .base = BPWM1, .name = "bpwm1i0", .irqn = BPWM1_IRQn, .rstidx = SYS_BPWM1RST, .modid = BPWM1_MODULE },
    {  .base = BPWM1, .name = "bpwm1i1", .irqn = BPWM1_IRQn, .rstidx = SYS_BPWM1RST, .modid = BPWM1_MODULE },
    {  .base = BPWM1, .name = "bpwm1i2", .irqn = BPWM1_IRQn, .rstidx = SYS_BPWM1RST, .modid = BPWM1_MODULE },
    {  .base = BPWM1, .name = "bpwm1i3", .irqn = BPWM1_IRQn, .rstidx = SYS_BPWM1RST, .modid = BPWM1_MODULE },
    {  .base = BPWM1, .name = "bpwm1i4", .irqn = BPWM1_IRQn, .rstidx = SYS_BPWM1RST, .modid = BPWM1_MODULE },
    {  .base = BPWM1, .name = "bpwm1i5", .irqn = BPWM1_IRQn, .rstidx = SYS_BPWM1RST, .modid = BPWM1_MODULE },
#endif
};
