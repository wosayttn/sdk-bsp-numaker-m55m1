...
uint32_t I2S_GetSourceClockFreq(I2S_T *i2s)
{
    ...
    if (i2s == I2S0)
    {
        ...
        switch (u32ClkSrcSel)
        {
            ...
            case CLK_I2SSEL_I2S0SEL_APLL0_DIV2:
                u32Freq = (CLK_GetAPLL0ClockFreq() >> 1);
                break;

            case CLK_I2SSEL_I2S0SEL_PCLK1:
                u32Freq = CLK_GetPCLK1Freq();
                break;

            case CLK_I2SSEL_I2S0SEL_HIRC:
                u32Freq = __HIRC;
                break;
    ...
    {
        /* get I2S selection clock source */
        u32ClkSrcSel = CLK_GetModuleClockSource(I2S1_MODULE);
        ...
        switch (u32ClkSrcSel)
        {
            ...
            case CLK_I2SSEL_I2S1SEL_APLL0_DIV2:
                u32Freq = (CLK_GetAPLL0ClockFreq() >> 1);
                break;

            case CLK_I2SSEL_I2S1SEL_PCLK3:
                u32Freq = CLK_GetPCLK3Freq();
                break;

            case CLK_I2SSEL_I2S1SEL_HIRC:
                u32Freq = __HIRC;
                break;

            case CLK_I2SSEL_I2S1SEL_HIRC48M:
                u32Freq = __HIRC48M;
                break;
