...
#define RTC_2POW13_CLK          (0x3 << RTC_TAMPCTL_DYNRATE_Pos) /*!< 1024 x 8 RTC clock cycles \hideinitializer */
#define RTC_2POW14_CLK          (0x4 << RTC_TAMPCTL_DYNRATE_Pos) /*!< 1024 x 16 RTC clock cycles \hideinitializer */
#define RTC_2POW15_CLK          (0x5 << RTC_TAMPCTL_DYNRATE_Pos) /*!< 1024 x 32 RTC clock cycles \hideinitializer */
#define RTC_2POW16_CLK          (0x6 << RTC_TAMPCTL_DYNRATE_Pos) /*!< 1024 x 64 RTC clock cycles \hideinitializer */
#define RTC_2POW17_CLK          (0x7 << RTC_TAMPCTL_DYNRATE_Pos) /*!< 1024 x 128 RTC clock cycles \hideinitializer */
