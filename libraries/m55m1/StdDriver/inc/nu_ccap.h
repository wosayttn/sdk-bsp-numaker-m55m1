...
#define CCAP_PAR_PLNFMT_YUV422          CCAP_PLN_OUTFMT_YUV422P
#define CCAP_PAR_PLNFMT_YUV420          CCAP_PLN_OUTFMT_YUV420P
#define CCAP_PAR_PLNFMT_DISABLE         CCAP_PLN_DISABLED
 ...
 */
#define CCAP_GET_INT_STS(ccap) (ccap->INTSTS)
 ...
 */
#define CCAP_GET_WAKEUP_FLAG(ccap)  ((ccap->MDTRG_WK >> CCAP_MDTRG_WK_WKF_Pos) & CCAP_MDTRG_WK_WKF_Msk)

/**
 * @brief     Clear CCAP Wake-up Flag
 */
#define CCAP_CLR_WAKEUP_FLAG(ccap)  (ccap->MDTRG_WK = CCAP_MDTRG_WK_WKF_Msk)
 ...
 *            3: TTMR1
 */
#define CCAP_GET_WAKEUP_SRC(ccap)   ((ccap->MDTRG_WK >> CCAP_MDTRG_WK_TRGSEL_Pos) & CCAP_MDTRG_WK_TRGSEL_Msk)
 ...
 */
#define CCAP_GET_WAKEUP_FUNC(ccap)  ((ccap->MDTRG_WK >> CCAP_MDTRG_WK_WKEN_Pos) & CCAP_MDTRG_WK_WKEN_Msk)
 ...
 */
#define CCAP_MD_ENABLE_WINDOW(ccap, u32WindowMsk) (ccap->MDCTL = (ccap->MDCTL & ~0xFFFF) | (u32WindowMsk))
 ...
 */
#define CCAP_MD_DISABLE_WINDOW(ccap, u32WindowMsk) (ccap->MDCTL = (ccap->MDCTL & ~(u32WindowMsk)))
 ...
 */
#define CCAP_MD_IS_WINDOW_ENABLED(ccap, u32WindowMsk)  (ccap->MDCTL & u32WindowMsk)
 ...
 *
 */
#define CCAP_MD_SET_TRIG_SRC(ccap, u32TrigSrc, bWakeUp) \
 ...
 *
 */
#define CCAP_MD_SET_TOTAL_THRESHOLD(ccap, u32TotalThreshold) (ccap->MDTTH = (u32TotalThreshold))

/**
 * @brief     Get CCAP Motion Detection Total Threshold (Summary of all windows)
 */
#define CCAP_MD_GET_TOTAL_THRESHOLD(ccap)   (ccap->MDTTH)

/**
 * @brief     Get CCAP Motion Detection Total Sum of Absolute Differences (Summary of all windows)
 */
#define CCAP_MD_GET_TOTAL_SAD(ccap)         (ccap->MDTSAD)
 ...
 */
#define CCAP_MD_SET_OVERFLOW_WIN_THRESHOLD(ccap, u32WinOverflowCnt) (ccap->MDWOCTH = (u32WinOverflowCnt))

/**
 * @brief     Get CCAP Motion Detection Window Overflow Count Threshold
 */
#define CCAP_MD_GET_OVERFLOW_WIN_THRESHOLD(ccap)  (ccap->MDWOCTH)

/**
 * @brief     Get CCAP Motion Detection Window Overflow Count
 */
#define CCAP_MD_GET_OVERFLOW_WIN_CNT(ccap)  (ccap->MDWOC)
 ...
 * @details   Set Camera Capture Interface motion detection total threshold
 */
#define CCAP_MD_SET_WIN_THRESHOLD(ccap, u32WinIdx, u32Threshold) (ccap->MDWTH[u32WinIdx] = (u32Threshold))
 ...
 * @param[in] u32WinIdx:        Motion Detection Window Index. It could be 0x0 ~ 0xF.
 */
#define CCAP_MD_GET_WIN_THRESHOLD(ccap, u32WinIdx)  (ccap->MDWTH[u32WinIdx])
 ...
 * @param[in] u32WinIdx:        Motion Detection Window Index. It could be 0x0 ~ 0xF.
 */
#define CCAP_MD_GET_WIN_SAD(ccap, u32WinIdx)  (ccap->MDWSAD[u32WinIdx])
 ...
 */
#define CCAP_FR_SET_SCALEDOWN_RATE(ccap, u8Num, u8Den)  (ccap->FRCTL = (((u8Num) & 0x3F) << CCAP_FRCTL_FRN_Pos) | (((u8Den) & 0x3F) << CCAP_FRCTL_FRM_Pos))

/**
 * @brief     Get Camera Capture Interface Frame Rate Scale Down Rate (1 ~ 100 %)
 */
#define CCAP_FR_GET_SCALEDOWN_RATE(ccap)  (((((ccap->FRCTL >> CCAP_FRCTL_FRN_Pos) & 0x3F) * 100) / ((ccap->FRCTL >> CCAP_FRCTL_FRM_Pos) & 0x3F)))
 ...
 */
__STATIC_INLINE void CCAP_SetPacketBuf(CCAP_T *ccap, uint32_t u32Address)
{
 ...
 */
__STATIC_INLINE void CCAP_SetPlanarBuf(CCAP_T *ccap, uint32_t u32YAddr, uint32_t u32UAddr, uint32_t u32VAddr)
{
    ccap->YBA = u32YAddr;
    ccap->UBA = u32UAddr;
    ccap->VBA = u32VAddr;
 ...
 */
__STATIC_INLINE void CCAP_Close(CCAP_T *ccap)
{
 ...
 */
__STATIC_INLINE void CCAP_EnableInt(CCAP_T *ccap, uint32_t u32IntMask)
{
 ...
 *             and Motion Detection Modes Interrupt.
 */
__STATIC_INLINE void CCAP_DisableInt(CCAP_T *ccap, uint32_t u32IntMask)
{
 ...
 */
__STATIC_INLINE uint32_t CCAP_IsIntEnabled(CCAP_T *ccap, uint32_t u32IntMask)
{
 ...
 */
__STATIC_INLINE void CCAP_EnableMono(CCAP_T *ccap, uint32_t u32Interface)
{
 ...
 */
__STATIC_INLINE void CCAP_DisableMono(CCAP_T *ccap)
{
 ...
 */
__STATIC_INLINE void CCAP_EnableUpdate(CCAP_T *ccap)
{
 ...
 */
__STATIC_INLINE void CCAP_EnableLumaYOne(CCAP_T *ccap, uint32_t u32Threshold)
{
 ...
 */
__STATIC_INLINE void CCAP_DisableLumaYOne(CCAP_T *ccap)
{
    ccap->CTL &= ~CCAP_CTL_Luma_Y_One_Msk;
}
 ...
 */
__STATIC_INLINE void CCAP_Start(CCAP_T *ccap)
{
    ccap->CTL |= CCAP_CTL_CCAPEN;
}
 ...
 */
__STATIC_INLINE void CCAP_SetPlanarYBuf(CCAP_T *ccap, uint32_t u32Address)
{
    ccap->YBA = u32Address;
    ccap->CTL |= CCAP_CTL_UPDATE_Msk;
}
 ...
 */
__STATIC_INLINE void CCAP_SetPlanarUBuf(CCAP_T *ccap, uint32_t u32Address)
{
    ccap->UBA = u32Address;
    ccap->CTL |= CCAP_CTL_UPDATE_Msk;
}
 ...
 */
__STATIC_INLINE void CCAP_SetPlanarVBuf(CCAP_T *ccap, uint32_t u32Address)
{
    ccap->VBA = u32Address;
    ccap->CTL |= CCAP_CTL_UPDATE_Msk;
}
 ...
 */
__STATIC_INLINE void CCAP_SetPacketStride(CCAP_T *ccap, uint32_t u32Stride)
{
 ...
 */
__STATIC_INLINE void CCAP_SetPlanarStride(CCAP_T *ccap, uint32_t u32Stride)
{
    ccap->STRIDE = (ccap->STRIDE & ~CCAP_STRIDE_PLNSTRIDE_Msk) | (u32Stride << CCAP_STRIDE_PLNSTRIDE_Pos);
}

__STATIC_INLINE void CCAP_EnablePipes(CCAP_T *ccap, uint32_t u32Pipes)
{
    ccap->CTL |= u32Pipes;
}

void CCAP_Open(CCAP_T *ccap, uint32_t u32Param, uint32_t u32OutFormat);
void CCAP_OpenPipes(CCAP_T *ccap, uint32_t u32SensorSetting, uint32_t u32SensorColorFmt, uint32_t u32OutPacketFmt, uint32_t u32OutPlanarFmt);
...
void CCAP_EnableLumaYOne(CCAP_T *ccap, uint32_t u32Threshold);
