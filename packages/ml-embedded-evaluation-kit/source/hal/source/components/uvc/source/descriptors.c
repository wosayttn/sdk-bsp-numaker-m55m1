...
const uint8_t gu8ConfigDescriptor[] __attribute__((aligned(4))) =
{
    ...
    //RGB565 GUID: MEDIASUBTYPE_RGB565, {0xe436eb7b, 0x524f, 0x11ce, 0x9f, 0x53, 0x00, 0x20, 0xaf, 0x0b, 0xa7, 0x70}
    ...
    0x07,           //bFrameIntervalType
    0x0a, 0x8b, 0x02, 0x00,     //dwMinFrameInterval
...
const uint8_t gu8StringLang[4] __attribute__((aligned(4))) =
{
    4,              /* bLength */
...
const uint8_t gu8VendorStringDesc[] __attribute__((aligned(4))) =
{
    16,
    DESC_STRING,
    'N', 0,
...
const uint8_t gu8ProductStringDesc[] __attribute__((aligned(4))) =
{
    22,             /* bLength          */
    DESC_STRING,    /* bDescriptorType  */
    'U', 0,
...
const uint8_t *gu8UsbHidReport[3] =
{
    NULL,
    NULL,
    NULL,
